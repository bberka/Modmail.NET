...
public static class DiscordBotDependency
{
    public static void Configure(WebApplicationBuilder builder)
    {
        builder.Services.AddDiscordClient(builder.Configuration.GetValue<string>("Bot:BotToken") ?? throw new Exception("BotToken is empty"),
            DiscordIntents.MessageContents | DiscordIntents.Guilds | DiscordIntents.GuildMessages | DiscordIntents.GuildMembers |
            DiscordIntents.DirectMessages | DiscordIntents.GuildMessageReactions | DiscordIntents.DirectMessageReactions);
        ...
        builder.Services.AddCommandsExtension((_, extension) =>
        {
            ...
            {
                PrefixResolver =
                    new DefaultPrefixResolver(true,
                        builder.Configuration.GetValue<string>("Bot:BotPrefix") ?? throw new Exception("BotPrefix is null")).ResolvePrefixAsync,
                IgnoreBots = true,
