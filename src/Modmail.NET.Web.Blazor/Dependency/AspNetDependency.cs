...
public static class AspNetDependency
{
    ...
    {
        var appLogger = new LoggerConfiguration().ReadFrom.Configuration(builder.Configuration, new ConfigurationReaderOptions
            {
                SectionName = "AppLogger"
            })
            .CreateLogger();

        var aspNetCoreLogger = new LoggerConfiguration().ReadFrom.Configuration(builder.Configuration, new ConfigurationReaderOptions
            {
