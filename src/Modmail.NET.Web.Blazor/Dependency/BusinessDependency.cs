...
public static class BusinessDependency
{
    ...
    {
        var efCoreLogger = new LoggerConfiguration().ReadFrom.Configuration(builder.Configuration, new ConfigurationReaderOptions
            {
        ...
        {
            var connString = botConfig.GetValue<string>("DbConnectionString") ?? throw new Exception("DbConnectionString is null");
            ;
            ...
            if (botConfig.GetValue<bool>("SensitiveDataLogging") && builder.Environment.IsDevelopment() &&
