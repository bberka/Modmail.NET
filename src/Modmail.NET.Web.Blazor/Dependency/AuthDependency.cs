        ...
        builder.Services.AddAuthentication(options =>
            ...
            .AddDiscord(x =>
            {
                ...
                x.Events.OnCreatingTicket += async context =>
                {
                    ...
                    var identifier = context.Principal.FindFirst(ClaimTypes.NameIdentifier)
                        ?.Value;
                    ...
                    var name = context.Principal.FindFirst(ClaimTypes.Name)
                        ?.Value;
                    ...
                    try
                    {
                        ...
                        {
                            Log.Warning("Discord.OAuth Role permission check failed, user does not have permission {UserId} {UserName}", userId,
                                name);
