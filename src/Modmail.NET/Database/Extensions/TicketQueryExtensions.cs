...
public static class TicketQueryExtensions
{
  ...
  public static IQueryable<Ticket> FilterByClosedDate(this IQueryable<Ticket> query, DateTime startDate, DateTime endDate) {
  ...
  public static IQueryable<Ticket> FilterByFeedbackStarRange(this IQueryable<Ticket> query, int minStar, int maxStar) {
    return query.Where(t => t.FeedbackStar >= minStar && t.FeedbackStar <= maxStar);
  }

  public static IQueryable<Ticket> FilterByLastMessageDate(this IQueryable<Ticket> query, DateTime startDate, DateTime endDate) {
