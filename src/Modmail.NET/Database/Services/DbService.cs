...
//   }
//
//   public async Task<GuildOption?> GetGuildOptionAsync() {
//     return await _dbContext.GuildOptions.FirstOrDefaultAsync(x => x.GuildId == MMConfig.This.MainServerId);
//   }
//
//   public async Task<Ticket?> GetActiveTicketAsync(ulong userId) {
//     return await _dbContext.Tickets
//                            .Include(x => x.GuildOption)
//                            .Include(x => x.OpenerUserInfo)
//                            .Include(x => x.CloserUserInfo)
...
//     _dbContext.Tickets.UpdateAsync(ticket);
//     await _dbContext.SaveChangesAsync();
//   }
//
...
//   }
//
//   public async Task AddTicketMessage(TicketMessage dbMessageLog) {
...
//       _dbContext.DiscordUserInfos.UpdateAsync(current);
//     }
//     else {
...
//     return await _dbContext.TicketBlacklists.AnyAsync(x => x.DiscordUserId == authorId);
//   }
//
...
//     var blacklist = await _dbContext.TicketBlacklists.FirstOrDefaultAsync(x => x.DiscordUserId == userId);
...
//     return await _dbContext.TicketBlacklists.Where(x => x.GuildId == guildId).Select(x => x.DiscordUserId).ToListAsync();
//   }
//
...
//   }
//
//   public async Task ProcessInsertFeedbackAsync(Guid ticketId, int starCount, string textInput) {
...
//   }
//
//   public async Task<bool> ExistsAsync(string relatedContent) {
...
//     _dbContext.TicketTypes.UpdateAsync(ticketType);
//     await _dbContext.SaveChangesAsync();
//   }
//
//   public async Task<DiscordUserInfo?> GetUserInfoAsync(ulong modUserId) {
//     return await _dbContext.DiscordUserInfos.FindAsync(modUserId);
//   }
//
...
//     _dbContext.GuildTeams.UpdateAsync(team);
//     await _dbContext.SaveChangesAsync();
//   }
// }
