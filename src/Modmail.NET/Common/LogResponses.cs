...
{
    public static DiscordEmbedBuilder NewTicketCreated(
        DiscordMessage initialMessage,
        DiscordChannel mailChannel,
        Guid ticketId
    )
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.NEW_TICKET_CREATED.GetTranslation())
    ...
    public static DiscordEmbed MessageSentByMod(
        DiscordMessage message,
        Guid ticketId,
        bool ticketAnonymous
    )
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.MESSAGE_SENT_BY_MOD.GetTranslation())
    ...
    public static DiscordEmbed MessageSentByUser(DiscordMessage message, Guid ticketId)
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.MESSAGE_SENT_BY_USER.GetTranslation())
            .WithUserAsAuthor(message.Author)
            .WithDescription(message.Content)
            .WithCustomTimestamp()
            .WithColor(DiscordColor.Green)
    ...
    public static DiscordEmbed BlacklistAdded(
        DiscordUserInfo author,
        DiscordUserInfo user,
        string? reason
    )
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.USER_BLACKLISTED.GetTranslation())
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.USER_BLACKLIST_REMOVED.GetTranslation())
            .WithUserAsAuthor(author)
            .WithColor(Colors.InfoColor)
            .AddField(LangKeys.USER.GetTranslation(), user.GetMention(), true)
            .AddField(LangKeys.USER_ID.GetTranslation(), user.Id.ToString(), true);
    ...
    {
        var logEmbed = new DiscordEmbedBuilder().WithTitle(LangKeys.FEEDBACK_RECEIVED.GetTranslation())
            .WithDescription(ticket.FeedbackMessage)
            .WithCustomTimestamp()
            .AddField(LangKeys.TICKET_ID.GetTranslation(), ticket.Id.ToString()
                .ToUpper())
    ...
    public static DiscordEmbedBuilder NoteAdded(
        Ticket ticket,
        TicketNote note,
        DiscordUserInfo user
    )
    {
        var noteAddedColorEmbed = new DiscordEmbedBuilder().WithColor(Colors.NoteAddedColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TICKET_TYPE_DELETED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TICKET_TYPE_UPDATED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
            .AddField(LangKeys.TICKET_TYPE.GetTranslation(), ticketType.Name, true)
            .AddField(LangKeys.EMOJI.GetTranslation(), ticketType.Emoji.GetStringOrNA(), true)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TICKET_TYPE_CREATED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
            .AddField(LangKeys.TICKET_TYPE.GetTranslation(), ticketType.Name, true)
            .AddField(LangKeys.EMOJI.GetTranslation(), ticketType.Emoji.GetStringOrNA(), true)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_CREATED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_REMOVED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_MEMBER_ADDED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_MEMBER_REMOVED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
            .AddField(LangKeys.USER.GetTranslation(), userInfo.GetMention(), true)
            .AddField(LangKeys.TEAM_NAME.GetTranslation(), name, true);
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_ROLE_ADDED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_ROLE_REMOVED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_RENAMED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.SETUP_COMPLETE.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.CONFIGURATION_UPDATED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
            .AddField(LangKeys.GUILD_ID.GetTranslation(), guildOption.GuildId.ToString())
            .AddField(LangKeys.GUILD_NAME.GetTranslation(), guildOption.Name, true)
    ...
    public static DiscordEmbedBuilder TeamUpdated(
        TeamPermissionLevel oldPermissionLevel,
    ...
    {
        var embed = new DiscordEmbedBuilder().WithTitle(LangKeys.TEAM_UPDATED.GetTranslation())
            .WithCustomTimestamp()
            .WithColor(Colors.InfoColor)
