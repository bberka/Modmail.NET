...
{
    public static DiscordMember[] ParsePermissionInfo(UserTeamInformation[] userTeamInformations, IReadOnlyCollection<DiscordMember> members)
    {
    ...
    public static DiscordOverwriteBuilder[] GetTicketPermissionOverwrites(DiscordGuild guild, DiscordMember[] members)
    {
