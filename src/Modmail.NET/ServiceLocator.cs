...
public static class ServiceLocator
{
    ...
    public static ModmailBot GetModmailBot()
    {
        return _serviceProvider?.GetRequiredService<ModmailBot>() ??
               throw new InvalidOperationException("ServiceLocator.ServiceProvider has not been initialized.");
    }

    public static BotConfig GetBotConfig()
    {
        return _serviceProvider?.GetRequiredService<IOptions<BotConfig>>()
            .Value ?? throw new InvalidOperationException("ServiceLocator.ServiceProvider has not been initialized.");
    }
