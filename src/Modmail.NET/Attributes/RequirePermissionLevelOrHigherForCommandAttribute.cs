...
public class RequirePermissionLevelOrHigherForCommandAttribute : CheckBaseAttribute
{
    ...
    public override async Task<bool> ExecuteCheckAsync(CommandContext ctx, bool help)
    {
        ...
        {
            await ctx.RespondAsync(Embeds.Error(LangKeys.YOU_DO_NOT_HAVE_PERMISSION_TO_USE_THIS_COMMAND
                .GetTranslation())); //TODO: Add another message
            return false;
        }
        ...
        var roleIdList = ctx.Member.Roles.Select(x => x.Id)
            .ToList();
