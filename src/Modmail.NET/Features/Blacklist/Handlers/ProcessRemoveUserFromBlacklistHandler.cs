...
public class ProcessRemoveUserFromBlacklistHandler : IRequestHandler<ProcessRemoveUserFromBlacklistCommand, Database.Entities.Blacklist>
{
    ...
    public ProcessRemoveUserFromBlacklistHandler(ModmailDbContext dbContext, IMediator mediator)
    {
    ...
    {
        var blacklist = await _dbContext.Blacklists.FilterByUserId(request.UserId)
