...
public class NotifyTicketTypeChangedTicketMessageHandler : INotificationHandler<NotifyTicketTypeChanged>
{
    ...
    public NotifyTicketTypeChangedTicketMessageHandler(ModmailBot bot, ISender sender)
    {
        _bot = bot;
        _sender = sender;
    }
    ...
    public async ValueTask Handle(NotifyTicketTypeChanged notification, CancellationToken cancellationToken)
    {
        ...
        var embed = new DiscordEmbedBuilder().WithTitle(Lang.TicketTypeChanged.Translate())
