...
public class NotifyTicketCreatedPrivateMessageHandler : INotificationHandler<NotifyTicketCreated>
{
	...
	public NotifyTicketCreatedPrivateMessageHandler(ISender sender,
	...
	public async ValueTask Handle(NotifyTicketCreated notification, CancellationToken cancellationToken) {
		...
		var ticketCreatedMessage = await channel.SendMessageAsync(YouHaveCreatedNewTicket(option,
		                                                                                  ticketTypes,
	...
	private static DiscordMessageBuilder YouHaveCreatedNewTicket(Option option,
