...
public sealed class TicketMessage
{
    ...
    public static TicketMessage MapFrom(Guid ticketId, DiscordMessage message)
    {
        ...
        return new TicketMessage
        {
            ...
            TicketId = ticketId,
            Attachments = message.Attachments.Select(x => TicketMessageAttachment.MapFrom(x, id))
                .ToList(),
    ...
    public static TicketMessage MapFrom(
        Guid ticketId,
        ulong authorId,
        ulong messageId,
        string messageContent,
        List<DiscordAttachment>? discordAttachments
    )
    {
        ...
        return new TicketMessage
        {
            ...
            TicketId = ticketId,
            Attachments = discordAttachments.Select(x => TicketMessageAttachment.MapFrom(x, id))
                .ToList(),
