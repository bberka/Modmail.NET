...
public class TicketSlashCommands : ApplicationCommandModule
{
    ...
    public async Task CloseTicket(
        ...
        [Option("reason", "Ticket closing reason. User will be notified of this reason.")] string? reason = null
    )
    {
    ...
    public async Task SetPriority(InteractionContext ctx, [Option("priority", "Priority of the ticket")] TicketPriority priority)
    {
    ...
    public async Task AddNote(InteractionContext ctx, [Option("note", "Note to add")] string note)
    {
    ...
    public async Task SetType(InteractionContext ctx, [Option("type", "Type of the ticket")] [Autocomplete(typeof(TicketTypeProvider))] string type)
    {
