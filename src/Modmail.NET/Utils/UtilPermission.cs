...
{
    public static ( List<DiscordMember> members, List<DiscordRole> roles) ParsePermissionInfo(
    ...
    public static List<DiscordOverwriteBuilder> GetTicketPermissionOverwrites(
        DiscordGuild guild,
